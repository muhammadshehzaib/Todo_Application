...
//     res.status(200).json({ status: true, data: completedNotes });
//   } catch (error) {
//     console.error(error);
//     res
//       .status(500)
//       .json({ message: "Error getting completed notes", error: error.message });
//   }
// });
...
//     res
//       .status(500)
//       .json({ message: "Error getting active notes", error: error.message });
//   }
// });
...
//     res
//       .status(500)
//       .json({ message: "Error getting Notes document", error: error.message });
//   }
// });
